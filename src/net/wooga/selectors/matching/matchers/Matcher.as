package net.wooga.selectors.matching.matchers {
	...
	//TODO (arneschroppe 06/06/2012) rename this to SimpleSelector. Remove the term "matcher" and replace it with terms from the standard. The Matcher is the Selector
